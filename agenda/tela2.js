...
import Button from './components_buttons/buttons';
import { useNavigation } from '@react-navigation/native'; //esse aq




export default function App() {
  const navigation = useNavigation() //essa aq
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Button style={styles.button_item} title="Recentes" onPress={() => {navigation.navigate('Tela1')}} icon={require('./assets/recente.png')} />
      <Button style={styles.button_item} title="Teclado" onPress={() => {'teclado.js'}} icon={require('./assets/teclado.png')} />
      <Button style={styles.button_item} title="Contatos" onPress={() => {'App.js'}} icon={require('./assets/lista.png')} />
      </View>
